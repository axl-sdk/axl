...
// ── Row + body renderers live in the shared `TraceEventList` component
// now so the Workflow Runner panel shares the exact same look & feel.
// See: src/client/components/shared/TraceEventList.tsx
