...
- **High-risk:** those two plus one focused `adversarial-code-reviewer` for
  provider semantics, state/data loss, streaming/redaction, security,
...
charters. Treat platform isolation as defense in depth because the host may
