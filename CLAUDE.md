...
packages/axl/src/
  ...
  event-stream.ts    — AxlEventBus (iterator + EventEmitter + curated views: .text, .lifecycle, .textByAsk, .partialObjects), EventStreamOptions (maxQueued + onOverflow). Shared between AxlStream and ctx.events
