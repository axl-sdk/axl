...
Anthropic reasoning-reset diagnostics contain only dropped-block counts and
known reason names. Signed thinking, transformation paths, and raw provider
response bodies never enter those events or Studio trace labels.
